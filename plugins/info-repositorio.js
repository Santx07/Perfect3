...
const handler = async (m, { conn, args, usedPrefix }) => {
   ...
   const res = await fetch('https://api.github.com/repos/Santx07/Perfect3');
   ...
   txt += `${tradutor.texto1[11]}\n_${usedPrefix}gitclone ${json?.html_url || 'https://github.com/Santx07/Perfect3'}_`;
...
handler.command = ['scriAWDAWDAWDpt', 'reposAWDAWDAWDWAitorio', 'rDAWDAWDASDWADWAepo']
