/**
ꜱᴀɴᴛx - ʙᴏᴛ @08._santiago17 - _antitrabas.js
...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  const fakemek = { 'key': { 'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net' }, 'message': { 'groupInviteMessage': { 'groupJid': '573132641948-1616969743@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': 'ꜱᴀɴᴛx - ʙᴏᴛ', 'jpegThumbnail': null } } };
