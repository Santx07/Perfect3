...
import {tiktokdl} from '@08._santiago17';
...
import('@xct007/frieren-scraper')
  ...
  .catch((error) => {
    console.error('SIGUEME AL INSTAGRAM @08._santiago17".');
  });
...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: 'ᴛʜᴇ ᴍʏsᴛɪᴄ - ʙᴏᴛ', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com/Santx07/Perfect3'}, mentionedJid: [m.sender]}}}, aa);
